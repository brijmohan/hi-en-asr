...
steps/decode_raw_fmllr.sh --config conf/decode.config --nj 4 --cmd "$decode_cmd" \
   exp/tri3c/graph data/test exp/tri3c/decode

#steps/decode_raw_fmllr.sh --config conf/decode.config --nj 3 --cmd "$decode_cmd" \
#   exp/tri3c/graph_ug data/test exp/tri3c/decode_ug

steps/decode_raw_fmllr.sh --use-normal-fmllr true --config conf/decode.config --nj 4 --cmd "$decode_cmd" \
   exp/tri3c/graph data/test exp/tri3c/decode_2fmllr

#steps/decode_raw_fmllr.sh --use-normal-fmllr true --config conf/decode.config --nj 3 --cmd "$decode_cmd" \
